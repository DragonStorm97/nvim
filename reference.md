...
<!-- TODO: update with actual list of plugins used -->
...
- `S`:
  ...
  - Flash Tree-sitter = selects flashed area
  - default = deletes the current line from `^`, and puts you in insert mode
...
- `gi` = go-to last place you left insert mode
...
- `gzn` = change number of neighbor lines
